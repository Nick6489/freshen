...
- Portable inventories must match the application's local owned-file list exactly. Adding/removing owned paths across versions requires an explicit policy migration; remote metadata cannot expand ownership by itself.
